...
app.get('/search', function(req,res){
  var mysql = req.app.get('mysql');
  var context = {};
  var sql = "SELECT food_truck_name, website_name FROM website INNER JOIN website ON foodtruck.food_truck_id = website.food_truck_id";
